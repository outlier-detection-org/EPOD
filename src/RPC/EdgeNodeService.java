...
public class EdgeNodeService {
  ...
  public interface Iface {
    ...
    public void processResult(java.util.List<java.lang.Double> unitID, java.util.List<RPC.UnitInNode> unitInNodeList) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void processResult(java.util.List<java.lang.Double> unitID, java.util.List<RPC.UnitInNode> unitInNodeList, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_processResult(java.util.List<java.lang.Double> unitID, java.util.List<RPC.UnitInNode> unitInNodeList) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class processResult_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      private java.util.List<RPC.UnitInNode> unitInNodeList;
      public processResult_call(java.util.List<java.lang.Double> unitID, java.util.List<RPC.UnitInNode> unitInNodeList, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.unitID = unitID;
  ...
  public static class processResult_args implements org.apache.thrift.TBase<processResult_args, processResult_args._Fields>, java.io.Serializable, Cloneable, Comparable<processResult_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<RPC.UnitInNode> unitInNodeList; // required
    ...
    public processResult_args(
      ...
      java.util.List<RPC.UnitInNode> unitInNodeList)
    {
      this();
      this.unitID = unitID;
      this.unitInNodeList = unitInNodeList;
    ...
    public processResult_args(processResult_args other) {
      ...
      if (other.isSetUnitInNodeList()) {
        java.util.List<RPC.UnitInNode> __this__unitInNodeList = new java.util.ArrayList<RPC.UnitInNode>(other.unitInNodeList.size());
        for (RPC.UnitInNode other_element : other.unitInNodeList) {
          __this__unitInNodeList.add(new RPC.UnitInNode(other_element));
        }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<RPC.UnitInNode> getUnitInNodeListIterator() {
      return (this.unitInNodeList == null) ? null : this.unitInNodeList.iterator();
    }

    public void addToUnitInNodeList(RPC.UnitInNode elem) {
      if (this.unitInNodeList == null) {
        this.unitInNodeList = new java.util.ArrayList<RPC.UnitInNode>();
      }
      this.unitInNodeList.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<RPC.UnitInNode> getUnitInNodeList() {
      return this.unitInNodeList;
    }

    public processResult_args setUnitInNodeList(@org.apache.thrift.annotation.Nullable java.util.List<RPC.UnitInNode> unitInNodeList) {
      this.unitInNodeList = unitInNodeList;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case UNIT_IN_NODE_LIST:
        if (value == null) {
          ...
          setUnitInNodeList((java.util.List<RPC.UnitInNode>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.unitID = new java.util.ArrayList<java.lang.Double>(_list18.size);
                  double _elem19;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.unitInNodeList = new java.util.ArrayList<RPC.UnitInNode>(_list21.size);
                  @org.apache.thrift.annotation.Nullable RPC.UnitInNode _elem22;
                  for (int _i23 = 0; _i23 < _list21.size; ++_i23)
                  {
                    _elem22 = new RPC.UnitInNode();
                    _elem22.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, processResult_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.unitInNodeList != null) {
          oprot.writeFieldBegin(UNIT_IN_NODE_LIST_FIELD_DESC);
          {
            ...
            for (RPC.UnitInNode _iter25 : struct.unitInNodeList)
            {
              _iter25.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetUnitInNodeList()) {
          {
            ...
            for (RPC.UnitInNode _iter27 : struct.unitInNodeList)
            {
              _iter27.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.unitID = new java.util.ArrayList<java.lang.Double>(_list28.size);
            double _elem29;
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.unitInNodeList = new java.util.ArrayList<RPC.UnitInNode>(_list31.size);
            @org.apache.thrift.annotation.Nullable RPC.UnitInNode _elem32;
            for (int _i33 = 0; _i33 < _list31.size; ++_i33)
            {
              _elem32 = new RPC.UnitInNode();
              _elem32.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.unSateUnits = new java.util.ArrayList<java.util.List<java.lang.Double>>(_list34.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, provideNeighborsResult_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.unSateUnits != null) {
          oprot.writeFieldBegin(UN_SATE_UNITS_FIELD_DESC);
          {
            ...
            for (java.util.List<java.lang.Double> _iter40 : struct.unSateUnits)
            {
              {
        ...
        if (struct.isSetUnSateUnits()) {
          {
            ...
            for (java.util.List<java.lang.Double> _iter42 : struct.unSateUnits)
            {
              {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.unSateUnits = new java.util.ArrayList<java.util.List<java.lang.Double>>(_list44.size);
