...
public class EdgeNodeService {
  ...
  public interface Iface {
     ...
     */
    public void receiveAndProcessFP(java.util.Map<java.util.List<Double>, Integer> fingerprints, int edgeDeviceHashCode) throws InvalidException, org.apache.thrift.TException;

    public void processResult(java.util.List<Double> unitID, java.util.List<UnitInNode> unitInNodeList) throws InvalidException, org.apache.thrift.TException;

    public void provideNeighborsResult(java.util.List<java.util.List<Double>> unSateUnits, int edgeNodeHash) throws InvalidException, org.apache.thrift.TException;

    public void uploadAllLocalData(java.util.List<Vector> data) throws InvalidException, org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void receiveAndProcessFP(java.util.Map<java.util.List<Double>, Integer> fingerprints, int edgeDeviceHashCode, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void processResult(java.util.List<Double> unitID, java.util.List<UnitInNode> unitInNodeList, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void provideNeighborsResult(java.util.List<java.util.List<Double>> unSateUnits, int edgeNodeHash, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void uploadAllLocalData(java.util.List<Vector> data, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_receiveAndProcessFP(java.util.Map<java.util.List<Double>, Integer> fingerprints, int edgeDeviceHashCode) throws org.apache.thrift.TException
    {
    ...
    public void send_processResult(java.util.List<Double> unitID, java.util.List<UnitInNode> unitInNodeList) throws org.apache.thrift.TException
    {
    ...
    public void recv_processResult() throws InvalidException, org.apache.thrift.TException
    {
    ...
    public void send_provideNeighborsResult(java.util.List<java.util.List<Double>> unSateUnits, int edgeNodeHash) throws org.apache.thrift.TException
    {
    ...
    public void recv_provideNeighborsResult() throws InvalidException, org.apache.thrift.TException
    {
    ...
    public void uploadAllLocalData(java.util.List<Vector> data) throws InvalidException, org.apache.thrift.TException
    {
      send_uploadAllLocalData(data);
      recv_uploadAllLocalData();
    }

    public void send_uploadAllLocalData(java.util.List<Vector> data) throws org.apache.thrift.TException
    {
      uploadAllLocalData_args args = new uploadAllLocalData_args();
      args.setData(data);
      sendBase("uploadAllLocalData", args);
    }

    public void recv_uploadAllLocalData() throws InvalidException, org.apache.thrift.TException
    {
      uploadAllLocalData_result result = new uploadAllLocalData_result();
      receiveBase(result, "uploadAllLocalData");
      if (result.invalid != null) {
        throw result.invalid;
      }
      return;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class receiveAndProcessFP_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private java.util.Map<java.util.List<Double>, Integer> fingerprints;
      private int edgeDeviceHashCode;
      public receiveAndProcessFP_call(java.util.Map<java.util.List<Double>, Integer> fingerprints, int edgeDeviceHashCode, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class processResult_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private java.util.List<Double> unitID;
      private java.util.List<UnitInNode> unitInNodeList;
      public processResult_call(java.util.List<Double> unitID, java.util.List<UnitInNode> unitInNodeList, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.unitID = unitID;
    ...
    public static class provideNeighborsResult_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private java.util.List<java.util.List<Double>> unSateUnits;
      private int edgeNodeHash;
      public provideNeighborsResult_call(java.util.List<java.util.List<Double>> unSateUnits, int edgeNodeHash, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public void uploadAllLocalData(java.util.List<Vector> data, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      uploadAllLocalData_call method_call = new uploadAllLocalData_call(data, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class uploadAllLocalData_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private java.util.List<Vector> data;
      public uploadAllLocalData_call(java.util.List<Vector> data, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.data = data;
      }
      ...
      @Override
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("uploadAllLocalData", org.apache.thrift.protocol.TMessageType.CALL, 0));
        uploadAllLocalData_args args = new uploadAllLocalData_args();
        args.setData(data);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public Void getResult() throws InvalidException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_uploadAllLocalData();
        return null;
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> java.util.Map<String,  org.apache.thrift.ProcessFunction<I, ? extends org.apache.thrift.TBase>> getProcessMap(java.util.Map<String, org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("uploadAllLocalData", new uploadAllLocalData());
      return processMap;
    }
    ...
    public static class uploadAllLocalData<I extends Iface> extends org.apache.thrift.ProcessFunction<I, uploadAllLocalData_args> {
      public uploadAllLocalData() {
        super("uploadAllLocalData");
      }

      @Override
      public uploadAllLocalData_args getEmptyArgsInstance() {
        return new uploadAllLocalData_args();
      }
      ...
      @Override
      public uploadAllLocalData_result getResult(I iface, uploadAllLocalData_args args) throws org.apache.thrift.TException {
        uploadAllLocalData_result result = new uploadAllLocalData_result();
        try {
          iface.uploadAllLocalData(args.data);
        } catch (InvalidException invalid) {
          result.invalid = invalid;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class uploadAllLocalData<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, uploadAllLocalData_args, Void> {
      public uploadAllLocalData() {
        super("uploadAllLocalData");
      }
      ...
      @Override
      public void start(I iface, uploadAllLocalData_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.uploadAllLocalData(args.data,resultHandler);
      }
    }
  ...
  public static class receiveAndProcessFP_args implements org.apache.thrift.TBase<receiveAndProcessFP_args, receiveAndProcessFP_args._Fields>, java.io.Serializable, Cloneable, Comparable<receiveAndProcessFP_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.Map<java.util.List<Double>, Integer> fingerprints; // required
    ...
    public receiveAndProcessFP_args(
      java.util.Map<java.util.List<Double>, Integer> fingerprints,
      int edgeDeviceHashCode)
    {
      this();
      this.fingerprints = fingerprints;
    ...
    public receiveAndProcessFP_args(receiveAndProcessFP_args other) {
      ...
      if (other.isSetFingerprints()) {
        java.util.Map<java.util.List<Double>, Integer> __this__fingerprints = new java.util.HashMap<java.util.List<Double>, Integer>(other.fingerprints.size());
        for (java.util.Map.Entry<java.util.List<Double>, Integer> other_element : other.fingerprints.entrySet()) {

          java.util.List<Double> other_element_key = other_element.getKey();
          Integer other_element_value = other_element.getValue();

          java.util.List<Double> __this__fingerprints_copy_key = new java.util.ArrayList<Double>(other_element_key);

          Integer __this__fingerprints_copy_value = other_element_value;
    ...
    public void putToFingerprints(java.util.List<Double> key, int val) {
      if (this.fingerprints == null) {
        this.fingerprints = new java.util.HashMap<java.util.List<Double>, Integer>();
      }
      this.fingerprints.put(key, val);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.Map<java.util.List<Double>, Integer> getFingerprints() {
      return this.fingerprints;
    }

    public receiveAndProcessFP_args setFingerprints(@org.apache.thrift.annotation.Nullable java.util.Map<java.util.List<Double>, Integer> fingerprints) {
      this.fingerprints = fingerprints;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case FINGERPRINTS:
        if (value == null) {
          ...
          setFingerprints((java.util.Map<java.util.List<Double>, Integer>)value);
        }
        break;
      ...
      case EDGE_DEVICE_HASH_CODE:
        if (value == null) {
          ...
          setEdgeDeviceHashCode((Integer)value);
        }
        break;
    ...
    public int compareTo(receiveAndProcessFP_args other) {
      ...
      lastComparison = Boolean.compare(isSetFingerprints(), other.isSetFingerprints());
      if (lastComparison != 0) {
      ...
      lastComparison = Boolean.compare(isSetEdgeDeviceHashCode(), other.isSetEdgeDeviceHashCode());
      if (lastComparison != 0) {
        return lastComparison;
      }
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("receiveAndProcessFP_args(");
      boolean first = true;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.fingerprints = new java.util.HashMap<java.util.List<Double>, Integer>(2*_map0.size);
                  @org.apache.thrift.annotation.Nullable java.util.List<Double> _key1;
                  int _val2;
                  for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                  {
                    {
                      org.apache.thrift.protocol.TList _list4 = iprot.readListBegin();
                      _key1 = new java.util.ArrayList<Double>(_list4.size);
                      double _elem5;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, receiveAndProcessFP_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.fingerprints != null) {
          oprot.writeFieldBegin(FINGERPRINTS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.util.List<Double>, Integer> _iter7 : struct.fingerprints.entrySet())
            {
              {
        ...
        if (struct.isSetFingerprints()) {
          {
            ...
            for (java.util.Map.Entry<java.util.List<Double>, Integer> _iter9 : struct.fingerprints.entrySet())
            {
              {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.fingerprints = new java.util.HashMap<java.util.List<Double>, Integer>(2*_map11.size);
            @org.apache.thrift.annotation.Nullable java.util.List<Double> _key12;
            int _val13;
            for (int _i14 = 0; _i14 < _map11.size; ++_i14)
            {
              {
                org.apache.thrift.protocol.TList _list15 = iprot.readListBegin();
                _key12 = new java.util.ArrayList<Double>(_list15.size);
                double _elem16;
  ...
  public static class receiveAndProcessFP_result implements org.apache.thrift.TBase<receiveAndProcessFP_result, receiveAndProcessFP_result._Fields>, java.io.Serializable, Cloneable, Comparable<receiveAndProcessFP_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("receiveAndProcessFP_result(");
      boolean first = true;
  ...
  public static class processResult_args implements org.apache.thrift.TBase<processResult_args, processResult_args._Fields>, java.io.Serializable, Cloneable, Comparable<processResult_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<Double> unitID; // required
    ...
    public processResult_args(processResult_args other) {
      if (other.isSetUnitID()) {
        java.util.List<Double> __this__unitID = new java.util.ArrayList<Double>(other.unitID);
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<Double> getUnitIDIterator() {
      return (this.unitID == null) ? null : this.unitID.iterator();
    }

    public void addToUnitID(double elem) {
      if (this.unitID == null) {
        this.unitID = new java.util.ArrayList<Double>();
      }
      this.unitID.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<Double> getUnitID() {
      return this.unitID;
    }

    public processResult_args setUnitID(@org.apache.thrift.annotation.Nullable java.util.List<Double> unitID) {
      this.unitID = unitID;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case UNIT_ID:
        if (value == null) {
          ...
          setUnitID((java.util.List<Double>)value);
        }
        break;
    ...
    public int compareTo(processResult_args other) {
      ...
      lastComparison = Boolean.compare(isSetUnitID(), other.isSetUnitID());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetUnitID()) {
      ...
      lastComparison = Boolean.compare(isSetUnitInNodeList(), other.isSetUnitInNodeList());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetUnitInNodeList()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("processResult_args(");
      boolean first = true;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.unitID = new java.util.ArrayList<Double>(_list18.size);
                  double _elem19;
                  for (int _i20 = 0; _i20 < _list18.size; ++_i20)
                  {
                    _elem19 = iprot.readDouble();
                    struct.unitID.add(_elem19);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.unitInNodeList = new java.util.ArrayList<UnitInNode>(_list21.size);
                  @org.apache.thrift.annotation.Nullable UnitInNode _elem22;
                  for (int _i23 = 0; _i23 < _list21.size; ++_i23)
                  {
                    _elem22 = new UnitInNode();
                    _elem22.read(iprot);
                    struct.unitInNodeList.add(_elem22);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, processResult_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.unitID != null) {
          oprot.writeFieldBegin(UNIT_ID_FIELD_DESC);
          {
            ...
            for (double _iter24 : struct.unitID)
            {
        ...
        if (struct.unitInNodeList != null) {
          oprot.writeFieldBegin(UNIT_IN_NODE_LIST_FIELD_DESC);
          {
            ...
            for (UnitInNode _iter25 : struct.unitInNodeList)
            {
              _iter25.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetUnitID()) {
          {
            ...
            for (double _iter26 : struct.unitID)
            {
        ...
        if (struct.isSetUnitInNodeList()) {
          {
            ...
            for (UnitInNode _iter27 : struct.unitInNodeList)
            {
              _iter27.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.unitID = new java.util.ArrayList<Double>(_list28.size);
            double _elem29;
            for (int _i30 = 0; _i30 < _list28.size; ++_i30)
            {
              _elem29 = iprot.readDouble();
              struct.unitID.add(_elem29);
            }
          }
          struct.setUnitIDIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.unitInNodeList = new java.util.ArrayList<UnitInNode>(_list31.size);
            @org.apache.thrift.annotation.Nullable UnitInNode _elem32;
            for (int _i33 = 0; _i33 < _list31.size; ++_i33)
            {
              _elem32 = new UnitInNode();
              _elem32.read(iprot);
              struct.unitInNodeList.add(_elem32);
            }
          }
          struct.setUnitInNodeListIsSet(true);
        }
  ...
  public static class processResult_result implements org.apache.thrift.TBase<processResult_result, processResult_result._Fields>, java.io.Serializable, Cloneable, Comparable<processResult_result>   {
    ...
    public processResult_result setInvalid(@org.apache.thrift.annotation.Nullable InvalidException invalid) {
      this.invalid = invalid;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("processResult_result(");
      boolean first = true;
  ...
  public static class provideNeighborsResult_args implements org.apache.thrift.TBase<provideNeighborsResult_args, provideNeighborsResult_args._Fields>, java.io.Serializable, Cloneable, Comparable<provideNeighborsResult_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<Double>> unSateUnits; // required
    ...
    public provideNeighborsResult_args(
      java.util.List<java.util.List<Double>> unSateUnits,
      int edgeNodeHash)
    {
      this();
      this.unSateUnits = unSateUnits;
    ...
    public provideNeighborsResult_args(provideNeighborsResult_args other) {
      ...
      if (other.isSetUnSateUnits()) {
        java.util.List<java.util.List<Double>> __this__unSateUnits = new java.util.ArrayList<java.util.List<Double>>(other.unSateUnits.size());
        for (java.util.List<Double> other_element : other.unSateUnits) {
          java.util.List<Double> __this__unSateUnits_copy = new java.util.ArrayList<Double>(other_element);
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<java.util.List<Double>> getUnSateUnitsIterator() {
      return (this.unSateUnits == null) ? null : this.unSateUnits.iterator();
    }

    public void addToUnSateUnits(java.util.List<Double> elem) {
      if (this.unSateUnits == null) {
        this.unSateUnits = new java.util.ArrayList<java.util.List<Double>>();
      }
      this.unSateUnits.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<java.util.List<Double>> getUnSateUnits() {
      return this.unSateUnits;
    }

    public provideNeighborsResult_args setUnSateUnits(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<Double>> unSateUnits) {
      this.unSateUnits = unSateUnits;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case UN_SATE_UNITS:
        if (value == null) {
          ...
          setUnSateUnits((java.util.List<java.util.List<Double>>)value);
        }
        break;
    ...
    public int compareTo(provideNeighborsResult_args other) {
      ...
      lastComparison = Boolean.compare(isSetUnSateUnits(), other.isSetUnSateUnits());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetUnSateUnits()) {
      ...
      lastComparison = Boolean.compare(isSetEdgeNodeHash(), other.isSetEdgeNodeHash());
      if (lastComparison != 0) {
        return lastComparison;
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("provideNeighborsResult_args(");
      boolean first = true;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.unSateUnits = new java.util.ArrayList<java.util.List<Double>>(_list34.size);
                  ...
                  for (int _i36 = 0; _i36 < _list34.size; ++_i36)
                  {
                    ...
                    struct.unSateUnits.add(_elem35);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, provideNeighborsResult_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.unSateUnits != null) {
          oprot.writeFieldBegin(UN_SATE_UNITS_FIELD_DESC);
          {
            ...
            for (java.util.List<Double> _iter40 : struct.unSateUnits)
            {
              {
        ...
        if (struct.isSetUnSateUnits()) {
          {
            ...
            for (java.util.List<Double> _iter42 : struct.unSateUnits)
            {
              {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.unSateUnits = new java.util.ArrayList<java.util.List<Double>>(_list44.size);
            ...
            for (int _i46 = 0; _i46 < _list44.size; ++_i46)
            {
              ...
              struct.unSateUnits.add(_elem45);
            }
          }
          struct.setUnSateUnitsIsSet(true);
        }
  ...
  public static class provideNeighborsResult_result implements org.apache.thrift.TBase<provideNeighborsResult_result, provideNeighborsResult_result._Fields>, java.io.Serializable, Cloneable, Comparable<provideNeighborsResult_result>   {
    ...
    public provideNeighborsResult_result setInvalid(@org.apache.thrift.annotation.Nullable InvalidException invalid) {
      this.invalid = invalid;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("provideNeighborsResult_result(");
      boolean first = true;
  ...
  @SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
  public static class uploadAllLocalData_args implements org.apache.thrift.TBase<uploadAllLocalData_args, uploadAllLocalData_args._Fields>, java.io.Serializable, Cloneable, Comparable<uploadAllLocalData_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("uploadAllLocalData_args");
    ...
    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new uploadAllLocalData_argsStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new uploadAllLocalData_argsTupleSchemeFactory();

    public @org.apache.thrift.annotation.Nullable java.util.List<Vector> data; // required
    ...
    static {
      ...
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(uploadAllLocalData_args.class, metaDataMap);
    }

    public uploadAllLocalData_args() {
    }

    public uploadAllLocalData_args(
      java.util.List<Vector> data)
    {
      this();
      this.data = data;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public uploadAllLocalData_args(uploadAllLocalData_args other) {
      if (other.isSetData()) {
        java.util.List<Vector> __this__data = new java.util.ArrayList<Vector>(other.data.size());
        for (Vector other_element : other.data) {
          __this__data.add(new Vector(other_element));
        }
    ...
    @Override
    public uploadAllLocalData_args deepCopy() {
      return new uploadAllLocalData_args(this);
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<Vector> getDataIterator() {
      return (this.data == null) ? null : this.data.iterator();
    }

    public void addToData(Vector elem) {
      if (this.data == null) {
        this.data = new java.util.ArrayList<Vector>();
      }
      this.data.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<Vector> getData() {
      return this.data;
    }

    public uploadAllLocalData_args setData(@org.apache.thrift.annotation.Nullable java.util.List<Vector> data) {
      this.data = data;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case DATA:
        if (value == null) {
          ...
          setData((java.util.List<Vector>)value);
        }
        break;
    ...
    @Override
    public boolean equals(Object that) {
      if (that instanceof uploadAllLocalData_args)
        return this.equals((uploadAllLocalData_args)that);
      return false;
    }

    public boolean equals(uploadAllLocalData_args that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(uploadAllLocalData_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("uploadAllLocalData_args(");
      boolean first = true;
    ...
    private static class uploadAllLocalData_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      @Override
      public uploadAllLocalData_argsStandardScheme getScheme() {
        return new uploadAllLocalData_argsStandardScheme();
      }
    }

    private static class uploadAllLocalData_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<uploadAllLocalData_args> {

      @Override
      public void read(org.apache.thrift.protocol.TProtocol iprot, uploadAllLocalData_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.data = new java.util.ArrayList<Vector>(_list50.size);
                  @org.apache.thrift.annotation.Nullable Vector _elem51;
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol oprot, uploadAllLocalData_args struct) throws org.apache.thrift.TException {
        struct.validate();
        ...
        if (struct.data != null) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (Vector _iter53 : struct.data)
            {
              _iter53.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class uploadAllLocalData_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      @Override
      public uploadAllLocalData_argsTupleScheme getScheme() {
        return new uploadAllLocalData_argsTupleScheme();
      }
    }

    private static class uploadAllLocalData_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<uploadAllLocalData_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, uploadAllLocalData_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetData()) {
          optionals.set(0);
        ...
        if (struct.isSetData()) {
          {
            ...
            for (Vector _iter54 : struct.data)
            {
              _iter54.write(oprot);
            }
          }
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, uploadAllLocalData_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list55 = iprot.readListBegin();
            struct.data = new java.util.ArrayList<Vector>(_list55.size);
            @org.apache.thrift.annotation.Nullable Vector _elem56;
  ...
  @SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
  public static class uploadAllLocalData_result implements org.apache.thrift.TBase<uploadAllLocalData_result, uploadAllLocalData_result._Fields>, java.io.Serializable, Cloneable, Comparable<uploadAllLocalData_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("uploadAllLocalData_result");

    private static final org.apache.thrift.protocol.TField INVALID_FIELD_DESC = new org.apache.thrift.protocol.TField("invalid", org.apache.thrift.protocol.TType.STRUCT, (short)1);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new uploadAllLocalData_resultStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new uploadAllLocalData_resultTupleSchemeFactory();
    ...
    static {
      ...
      tmpMap.put(_Fields.INVALID, new org.apache.thrift.meta_data.FieldMetaData("invalid", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, InvalidException.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(uploadAllLocalData_result.class, metaDataMap);
    }

    public uploadAllLocalData_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public uploadAllLocalData_result(uploadAllLocalData_result other) {
      if (other.isSetInvalid()) {
        this.invalid = new InvalidException(other.invalid);
      }
    }
    ...
    @Override
    public uploadAllLocalData_result deepCopy() {
      return new uploadAllLocalData_result(this);
    }
    ...
    public uploadAllLocalData_result setInvalid(@org.apache.thrift.annotation.Nullable InvalidException invalid) {
      this.invalid = invalid;
      return this;
    }
    ...
    @Override
    public boolean equals(Object that) {
      if (that instanceof uploadAllLocalData_result)
        return this.equals((uploadAllLocalData_result)that);
      return false;
    }

    public boolean equals(uploadAllLocalData_result that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(uploadAllLocalData_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("uploadAllLocalData_result(");
      boolean first = true;
    ...
    private static class uploadAllLocalData_resultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      @Override
      public uploadAllLocalData_resultStandardScheme getScheme() {
        return new uploadAllLocalData_resultStandardScheme();
      }
    }

    private static class uploadAllLocalData_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<uploadAllLocalData_result> {

      @Override
      public void read(org.apache.thrift.protocol.TProtocol iprot, uploadAllLocalData_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol oprot, uploadAllLocalData_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class uploadAllLocalData_resultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      @Override
      public uploadAllLocalData_resultTupleScheme getScheme() {
        return new uploadAllLocalData_resultTupleScheme();
      }
    }

    private static class uploadAllLocalData_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<uploadAllLocalData_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, uploadAllLocalData_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetInvalid()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, uploadAllLocalData_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.invalid = new InvalidException();
