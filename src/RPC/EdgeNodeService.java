...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.18.0)", date = "2023-04-22")
...
public class EdgeNodeService {
  ...
  public interface Iface {
    ...
    public java.util.Set<Vector> uploadAndDetectOutlier(java.util.List<Vector> data) throws InvalidException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void uploadAndDetectOutlier(java.util.List<Vector> data, org.apache.thrift.async.AsyncMethodCallback<java.util.Set<Vector>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_uploadAndDetectOutlier(java.util.List<Vector> data) throws org.apache.thrift.TException
    {
    ...
    public java.util.Set<Vector> recv_uploadAndDetectOutlier() throws InvalidException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class uploadAndDetectOutlier_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.Set<Vector>> {
      private java.util.List<Vector> data;
      public uploadAndDetectOutlier_call(java.util.List<Vector> data, org.apache.thrift.async.AsyncMethodCallback<java.util.Set<Vector>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.data = data;
      }
      ...
      @Override
      public java.util.Set<Vector> getResult() throws InvalidException, org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class uploadAndDetectOutlier<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, uploadAndDetectOutlier_args, java.util.Set<Vector>> {
      public uploadAndDetectOutlier() {
        super("uploadAndDetectOutlier");
      }
      ...
      @Override
      public org.apache.thrift.async.AsyncMethodCallback<java.util.Set<Vector>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.Set<Vector>>() {
          @Override
          public void onComplete(java.util.Set<Vector> o) {
            uploadAndDetectOutlier_result result = new uploadAndDetectOutlier_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      @Override
      public void start(I iface, uploadAndDetectOutlier_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.Set<Vector>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class uploadAndDetectOutlier_args implements org.apache.thrift.TBase<uploadAndDetectOutlier_args, uploadAndDetectOutlier_args._Fields>, java.io.Serializable, Cloneable, Comparable<uploadAndDetectOutlier_args>   {
    ...
    public uploadAndDetectOutlier_args setData(@org.apache.thrift.annotation.Nullable java.util.List<Vector> data) {
      this.data = data;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("uploadAndDetectOutlier_args(");
      boolean first = true;
  ...
  public static class uploadAndDetectOutlier_result implements org.apache.thrift.TBase<uploadAndDetectOutlier_result, uploadAndDetectOutlier_result._Fields>, java.io.Serializable, Cloneable, Comparable<uploadAndDetectOutlier_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.Set<Vector> success; // required
    public @org.apache.thrift.annotation.Nullable InvalidException invalid; // required
    ...
    public uploadAndDetectOutlier_result(uploadAndDetectOutlier_result other) {
      if (other.isSetSuccess()) {
        java.util.Set<Vector> __this__success = new java.util.HashSet<Vector>(other.success.size());
    ...
    public void addToSuccess(Vector elem) {
      if (this.success == null) {
        this.success = new java.util.HashSet<Vector>();
      }
      this.success.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.Set<Vector> getSuccess() {
      return this.success;
    }

    public uploadAndDetectOutlier_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.Set<Vector> success) {
      this.success = success;
      return this;
    }
    ...
    public uploadAndDetectOutlier_result setInvalid(@org.apache.thrift.annotation.Nullable InvalidException invalid) {
      this.invalid = invalid;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.Set<Vector>)value);
        }
        break;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("uploadAndDetectOutlier_result(");
      boolean first = true;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.success = new java.util.HashSet<Vector>(2*_set58.size);
                  @org.apache.thrift.annotation.Nullable Vector _elem59;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, uploadAndDetectOutlier_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Vector _iter61 : struct.success)
            {
              _iter61.write(oprot);
            }
            oprot.writeSetEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Vector _iter62 : struct.success)
            {
              _iter62.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.HashSet<Vector>(2*_set63.size);
            @org.apache.thrift.annotation.Nullable Vector _elem64;
