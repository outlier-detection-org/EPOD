...
public final class DistanceFunctions {
	 ...
	 * coordinates}.
	 */
	public static final DistanceFunction<EuclideanCoordinate> EUCLIDEAN = new DistanceFunction<EuclideanCoordinate>() {
		@Override
