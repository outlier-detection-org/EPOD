...
public class Index implements Serializable {
     ...
     * hash table. More concatenated hashes means that less candidates are
     * selected for evaluation.
     * @param numberOfHashTables The number of hash tables in use, recall
     * increases with the number of hash tables. Memory use also increases. Time
     * needed to compute a hash also increases marginally.
     */
     ...
     *
     * @return The number of hashes used in each hash table in the current
     * index.
     */
     ...
     * @param maxSize The maximum number of neighbours to return. Beware, the
     * number of neighbours returned lays between zero and the chosen maximum.
...
//		return candidates;
    ...
    /**
     * The number of near neighbour candidates that are evaluated during the
     * queries on this index. Can be used to calculate the average evaluations
     * per query.
     *
     * @return The number of near neighbour candidates that are evaluated during
     * the queries on this index.
     */
    ...
    /**
     * Deserializes the hash table from disk. If deserialization fails, a new
     * hash table object is created.
     *
